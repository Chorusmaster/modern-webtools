...
import{_ as t,a as o}from"./index-DX1Z0aDf.js";import{b as a,r as s,o as c}from"./vendor-BSRx87Xs.js";const r=()=>t(()=>import("./CodeTemplate-CUxhVtDI.js"),__vite__mapDeps([0,1,2,3,4,5])),n={components:{CodeTemplate:r}};function i(d,p,l,m,v,u){const e=s("CodeTemplate");return c(),a(e,{technology:"Axios",list:["Axios is a library for Vue that is used for making http requests","With Axios you can connect to backend and therefore store data","In this project Axios is used to save basket even when the page was reloaded"],code:`<v-col
...
</v-col>`})}const f=o(n,[["render",i]]);export{f as default};
