  ...
  <div class='clear-format'>
    <div class="d-flex justify-between!">
      <div class="d-flex flex-col! justify-center ml-16! mb-5! p-4!">
        ...
        <h2 class="products-count mt-2! mb-2! pb-2.5! text-5xl! font-normal! text-[#4DE600]!"><span class="font-semibold!">0</span> products</h2>
    ...
    <div class="scroll-container d-flex items-center! flex-row! px-[5vw]! overflow-hidden!">
      <button id="left-slide" class="h-15! w-10! mt-8! text-2xl! bg-transparent! border-none!"><</button>
      <div id="cards-container" class="mt-15! w-screen! d-flex flex-row! overflow-x-auto scrollbar-hide"></div>
      <button id="right-slide" class="h-15! w-10! mt-8! text-2xl! bg-transparent! border-none!">></button>
    </div>
  </div>
</template>
